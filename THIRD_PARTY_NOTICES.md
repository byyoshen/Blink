...
| Asset | Origin | Notice |
| --- | --- | --- |
| `engine/portal/public/blink-logo-dark.webp` | Repository owner (original IP mascot) | Blink brand mascot, dark-theme badge (white bear on near-black), used in the portal navigation and footer. Full-bleed square: the portal crops it to a circle at display size. Owned by the repository owner; not covered by any third-party license. |
| `engine/portal/public/blink-logo-light.webp` | Repository owner (original IP mascot) | Light-theme badge of the same mascot (black bear on off-white), used when the portal theme is light. Owned by the repository owner; not covered by any third-party license. |
| `engine/portal/public/og-image.png` | Repository owner (original IP mascot) | The dark badge as the portal's Open Graph image. Kept as PNG rather than WebP because link-preview scrapers support it unevenly. Owned by the repository owner; not covered by any third-party license. |
| `engine/portal/public/favicon-dark.png` | Repository owner (original IP mascot) | Circular-cropped variant of the dark badge (transparent corners baked in, since browsers do not round a favicon), used as the browser-tab icon for the dark theme. PNG for the same compatibility reason. Owned by the repository owner; not covered by any third-party license. |
| `engine/portal/public/favicon-light.png` | Repository owner (original IP mascot) | Circular-cropped variant of the light badge, used as the browser-tab icon for the light theme. Owned by the repository owner; not covered by any third-party license. |
| `engine/docs/images/banner-on-dark.webp` | Repository owner (original IP mascot) | Blink title banner (mascot plus wordmark on a near-black field), shown at the top of the README under a dark colour scheme. Owned by the repository owner; not covered by any third-party license. |
| `engine/docs/images/banner-on-light.webp` | Repository owner (original IP mascot) | The same banner on an off-white field, shown under a light colour scheme. Owned by the repository owner; not covered by any third-party license. |
