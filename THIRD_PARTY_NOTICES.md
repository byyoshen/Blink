...
| Asset | Origin | Notice |
| --- | --- | --- |
| `engine/portal/public/blink-logo-dark.png` | Repository owner (original IP mascot) | Blink brand mascot, dark-theme badge (white bear on near-black), used in the portal navigation and footer and as the Open Graph image. Full-bleed square: the portal crops it to a circle at display size. Owned by the repository owner; not covered by any third-party license. |
| `engine/portal/public/blink-logo-light.png` | Repository owner (original IP mascot) | Light-theme badge of the same mascot (black bear on off-white), used when the portal theme is light. Owned by the repository owner; not covered by any third-party license. |
| `engine/portal/public/favicon-dark.png` | Repository owner (original IP mascot) | Circular-cropped variant of `blink-logo-dark.png` (transparent corners baked in, since browsers do not round a favicon), used as the browser-tab icon for the dark theme. Owned by the repository owner; not covered by any third-party license. |
| `engine/portal/public/favicon-light.png` | Repository owner (original IP mascot) | Circular-cropped variant of `blink-logo-light.png`, used as the browser-tab icon for the light theme. Owned by the repository owner; not covered by any third-party license. |
